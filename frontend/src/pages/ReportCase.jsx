...
import { FaEdit, FaCheckCircle, FaMapMarkerAlt, FaExclamationCircle } from 'react-icons/fa'
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-heading font-bold text-navy mb-4">
            <span className="flex items-center justify-center gap-2">
              <FaEdit className="text-primary" /> Report a Dengue Case
            </span>
          </h1>
        ...
        >
          <h2 className="text-xl font-heading font-bold text-red-900 mb-4 flex items-center gap-2">
            <FaExclamationCircle /> Emergency Hotlines
          </h2>

...
import BarangaySearchFilter from '../components/BarangaySearchFilter'
...
const BarangayPage = ({ barangay }) => {
  ...
  const [weatherParam, setWeatherParam] = useState('temperature')
    ...
    <div className="min-h-screen pt-24 bg-gray-50 animate-fade-in">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <BarangaySearchFilter
          ...
          onWeatherParamChange={setWeatherParam}
        />

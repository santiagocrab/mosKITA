...
import { FaMapMarkerAlt, FaSearch, FaCity } from 'react-icons/fa'
        ...
        >
          <h1 className="text-4xl md:text-5xl font-heading font-bold text-navy mb-4">
            <span className="flex items-center justify-center gap-2">
              <FaMapMarkerAlt className="text-primary" /> Barangay Risk Monitoring
            </span>
          </h1>
        ...
        >
          <div className="max-w-2xl mx-auto">
            <div className="relative">
              ...
              />
              <FaSearch className="absolute left-4 top-1/2 transform -translate-y-1/2 text-2xl text-gray-400" />
            </div>
          </div>
        </motion.div>
                  ...
                  >
                    ...
                    >
                      <div className="mb-4 flex justify-center">
                        <FaCity className="text-4xl text-primary" />
                      </div>

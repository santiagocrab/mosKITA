...
import { FaThermometerHalf, FaTint, FaCloudRain, FaArrowUp, FaArrowDown, FaArrowRight } from 'react-icons/fa'
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className={`text-xs mt-1 flex items-center gap-1 ${
              ...
              {tempDiff > 0 ? <FaArrowUp /> : tempDiff < 0 ? <FaArrowDown /> : <FaArrowRight />} {Math.abs(tempDiff).toFixed(1)}°C vs yesterday
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className={`text-xs mt-1 flex items-center gap-1 ${
              ...
              {humidityDiff > 0 ? <FaArrowUp /> : humidityDiff < 0 ? <FaArrowDown /> : <FaArrowRight />} {Math.abs(humidityDiff)}% vs last week avg
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className={`text-xs mt-1 flex items-center gap-1 ${
              ...
              {rainTrend === 'up' ? <><FaArrowUp className="rotate-45" /> Increasing</> : rainTrend === 'down' ? <><FaArrowDown className="rotate-45" /> Decreasing</> : <><FaArrowRight /> Stable</>}
            </div>
          </div>
        </div>
      </div>

  ...
  return (
    <div className="bg-white rounded-xl p-4 shadow-lg border-2 border-gray-200 animate-slide-up">
      <h3 className="text-lg font-bold text-gray-900 mb-3 flex items-center gap-2">
        <FaMapMarkerAlt className="text-primary" /> Real-time insights that help communities prepare, respond, and stay safe.
      </h3>
                  ...
                  <div className="p-2">
                    ...
                    <div className={`mt-2 px-2 py-1 rounded text-xs font-semibold ${
                      ...
                      <span className="flex items-center gap-1">
                        <FaCircle className={risk === 'High' ? 'text-red-500' : risk === 'Moderate' ? 'text-yellow-500' : risk === 'Low' ? 'text-green-500' : 'text-gray-500'} style={{ fontSize: '0.5rem' }} />

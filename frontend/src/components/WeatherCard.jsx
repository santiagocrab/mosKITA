...
const WeatherCard = () => {
  ...
  const getWeatherIcon = (condition) => {
    ...
    const icons = {
      'Clear': <FaSun className={iconClass} />,
      'Clouds': <FaCloud className={iconClass} />,
      'Rain': <FaCloudRain className={iconClass} />,
      'Drizzle': <FaCloudSunRain className={iconClass} />,
      'Thunderstorm': <FaBolt className={iconClass} />,
      'Mist': <FaCloud className={iconClass} />,
      'Fog': <FaCloud className={iconClass} />
    }
    return icons[condition] || <FaCloud className={iconClass} />
  }
